...
"""
ML Pipeline Part 3: Train Final Sales Property Classifier
...
CLASSIFIER_FILENAME = "sale_property_classifier.pkl"
FINAL_FEATURES_FILENAME = "sale_classifier_features.json"
...
if __name__ == "__main__":
    ...
    if df is not None and best_params is not None:
        ...
        y = df_filtered['cluster_target']
        X = df_filtered.drop(columns=[
            'price_eur', 'barrio_encoded', 'cluster_label', 
        ...
        cm_filename = "sale_classifier_confusion_matrix.html"
